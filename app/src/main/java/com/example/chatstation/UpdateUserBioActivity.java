...
public class UpdateUserBioActivity extends AppCompatActivity {

    private TextInputEditText bio;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_user_bio);
        Objects.requireNonNull(getSupportActionBar()).setTitle(getIntent().getStringExtra("name"));
        bio = findViewById(R.id.user_update_bio);
    ...
    public void updateBio(){
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            reference.child("Bio").setValue(Objects.requireNonNull(bio.getText()).toString());
